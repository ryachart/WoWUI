...
main.grabDefault = CreateFrame("CheckButton", nil, main.buttonSettingsPanel, "HidingBarAddonCheckButtonTemplate")
main.grabDefault:SetPoint("TOPLEFT", 8, -8)
main.grabDefault.Text:SetText(L["Grab default buttons on minimap"])
main.grabDefault:SetChecked(config.grabDefMinimap)
main.grabDefault:SetScript("OnClick", function(btn)
	config.grabDefMinimap = btn:GetChecked()
