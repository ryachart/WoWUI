...
L["CANCEL_UNDERCUT_BUTTON_MACRO"] = "取消有更低价的按钮宏"
L["CANCELLING_TAB"] = "取消"
...
L["CONFIG_SELLING_GEAR_USE_ILVL"] = "比较装备价格时考虑物品等级"
L["CONFIG_SELLING_GEAR_USE_ILVL_TOOLTIP_HEADER"] = "使用物品等级"
L["CONFIG_SELLING_GEAR_USE_ILVL_TOOLTIP_TEXT"] = "比较装备时通常会和其他类似的装备比较而不考虑物品等级差异。此选项会把物品等级也纳入考虑。"
