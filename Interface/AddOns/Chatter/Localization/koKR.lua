...
L["(|HBNplayer.-|h) whispers:"] = "(|HBNplayer.-|h)의 귓속말:"
L["(|HBNplayer.-|h): whispers:"] = "(|HBNplayer.-|h): 귓속말:"
...
L["Allows you to use the edge for resizing, instead of just the lower right corner."] = "크기 변경에 오른쪽 하단 모서리 대신 모든 모서리를 사용할 수 있게 변경합니다."
...
L["Disable server side storage of chat frame position and size."] = "대화창 위치 및 크기를 서버에 저장하지 않습니다."
L["Disabled"] = "미사용중"
L["Druid"] = "드루이드"
...
L["Enables you to replace channel names with your own names. You can use '%s' to force an empty string."] = "자신의 이름을 채널 이름에 대체 할 수 있습니다. '%s'을 사용하여 공백을 표시합니다."
L["Enables you to right-click a person's name in chat and set a note on them to be displayed in chat, such as their main character's name. Can also scan guild notes for character names to display, if no note has been manually set."] = "채팅창의 개인 이름을 우클릭 시 채팅창에 노트 된 것을 마치 주력 캐릭터의 이름으로 보여주게 되며 캐릭터 이름의 길드 노트 또한 검색하여 보여줍니다."
...
L["Move the Toast X offset to ChatFrame1"] = "ChatFrame1의 Toast X 위치를 변경합니다."
L["Move the Toast Y offset, relative to ChatFrame1"] = "ChatFrame1의 Toast Y 위치를 변경합니다."
L["Name"] = "이름"
L["Name color"] = "이름 색상"
...
L["Separator"] = "분리대"
L["Server Positioning"] = "서버에 저장"
L["Set Main"] = "플레이어 메모"
L["Set the coloring mode for alt names"] = "플레이어 메모 색상 표시 방법을 선택합니다."
L["Sets the alpha value for your chat tabs"] = "대화창 탭 투명도를 변경합니다."
...
L["Show copy icon"] = "복사 아이콘 표시"
L["Show highlights in your SCT mod"] = "강조 내용을 SCT로 보여줍니다."
L["Show SCT message"] = "SCT 메시지 표시"
L["Show Toast Icons"] = "Toast 아이콘 표시"
L["Show toast icons in the chat frames"] = "대화 창에 Toast 아이콘을 표시합니다."
...
L["Timestamps"] = "시간표시"
L["Tiny Chat"] = "작은 대화창"
L["To (|HBNplayer.-|h):"] = "(|HBNplayer.-|h)에게 귓속말:"
L["To (|Hplayer.-|h):"] = "(|Hplayer.-|h) 님에게 귓속말:"
L["To <Away>(|HBNplayer.-|h):"] = "<자리 비움>(|HBNplayer.-|h)에게 귓속말:"
L["To <Busy>(|HBNplayer.-|h):"] = "<다른 용무 중>(|HBNplayer.-|h)에게 귓속말:"
L["Toast X offset"] = "Toast X 좌표"
L["Toast Y offset"] = "Toast Y 좌표"
L["Toggle the copy icon on the chat frame."] = "대화창에 복사 아이콘을 표시 전환합니다."
L["Top"] = "위"
L["Trade -"] = "거래 -"
L["URL Copy"] = "인터넷 주소"
