...
L["Button Offset"] = "Décalage du bouton"
...
L["Configure the Reputation Bar"] = "Configurer la barre de réputation"
L["Configure the scale of the bar."] = "Configure l'échelle de la barre."
L["Configure the Status Tracking Bar"] = "Configurer la barre de suivi de l'état"
L["Configure the VehicleBar"] = "Configure la barre du véhicule."
L["Configure the XP Bar"] = "Configurer la barre XP"
...
L["Enable the Reputation Bar"] = "Activer la barre de réputation"
L["Enable the StanceBar"] = "Active la barre des postures."
L["Enable the Status Tracking Bar"] = "Activer la barre de suivi de l'état"
...
L["Enable the XP Bar"] = "Activer la barre XP"
...
L["Griffin"] = "Griffon"
L["Hide Artwork"] = "Masquer l'illustration"
...
L["Hide the Extra Action Button artwork."] = "Masquez l'illustration du bouton d'action supplémentaire."
...
L["How many buttons to offset the action to the left. This can be used, for example, to use the same actions on two individual shorter bars (front and back)."] = "Combien de boutons pour décaler l'action vers la gauche. Cela peut être utilisé, par exemple, pour utiliser les mêmes actions sur deux barres plus courtes individuelles (avant et arrière)."
...
L["Its simple! Just check the Keyring option in the BagBars configuration menu, and it'll appear next to your bags."] = "C'est simple! Cochez simplement l'option Porte-clés dans le menu de configuration BagBars, et elle apparaîtra à côté de vos sacs."
...
L["My BagBar does not have the Keyring on it, how do i get it back?"] = "Mon BagBar n'a pas de porte-clés dessus, comment le récupérer?"
...
L["Show the keyring button."] = "Afficher le bouton du Porte-clés"
...
L["Status Tracking Bar"] = "Barre de suivi de l'état"
L["Status Tracking Bar (XP/Rep/...)"] = "Barre de suivi de l'état (XP/Rep/...)"
...
For more style options you need to install Masque]=] ] = [=[Zoome ou non sur les boutons
